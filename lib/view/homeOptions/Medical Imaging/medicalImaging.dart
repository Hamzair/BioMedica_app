...
class MedicalIimaging extends StatefulWidget {
  const MedicalIimaging({super.key});

  @override
  State<MedicalIimaging> createState() => _MedicalIimagingState();
}

class _MedicalIimagingState extends State<MedicalIimaging> {
