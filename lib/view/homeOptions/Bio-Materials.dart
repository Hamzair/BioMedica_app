...
class BioMaterials extends StatefulWidget {
  const BioMaterials({super.key});

  @override
  State<BioMaterials> createState() => _BioMaterialsState();
}

class _BioMaterialsState extends State<BioMaterials> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(
      'assets/videos/video3.mp4', // Replace with your video path
    )..initialize().then((_) {
      setState(() {});
    });
  }
