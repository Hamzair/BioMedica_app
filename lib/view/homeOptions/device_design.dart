...
class DeviceDesign extends StatefulWidget {
  const DeviceDesign({super.key});

  @override
  State<DeviceDesign> createState() => _DeviceDesignState();
}

class _DeviceDesignState extends State<DeviceDesign> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(
      'assets/videos/video2.mp4', // Replace with your video path
    )..initialize().then((_) {
      setState(() {});
    });
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    /// ClipRRect to add border radius
                    ClipRRect(
