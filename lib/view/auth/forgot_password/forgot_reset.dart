                  ...
                  children: [
                    ...
                    GetBuilder<AuthController>(builder: (_authController) {
                      ...
                      double checks = (containsNumberOrSymbol ? 0.5 : 0) +
                          ...
                          (_authController.newPasswordController.value.length >=
                                  8
                              ? 2
                              : 0);
                      ...
                      return Column(
                        children: [
                          Row(
                            ...
                            children: [
                              _authController.newPasswordController.value
                                  .length >=
                                  8
                                  ? Image.asset(
                                AppImages.tickIcon,
                          ...
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              numberOrSymbolRegExp.hasMatch(_authController
