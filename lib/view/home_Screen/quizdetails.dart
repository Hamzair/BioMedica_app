                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GridView.builder(
                      itemCount:
                      QuizImages.length, // Adjust the count dynamically
...
class QuizCard extends StatelessWidget {
  ...
  QuizCard({required this.image, required this.name,});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
       Get.to(()=>QuizCourses( QuizNames: name,));
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding:  EdgeInsets.symmetric(horizontal: 6.57.h,vertical: 6.57.h),
              child: ClipRRect(
