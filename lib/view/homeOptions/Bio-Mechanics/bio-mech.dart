...
class BioMechanics extends StatefulWidget {
  const BioMechanics({super.key});

  @override
  State<BioMechanics> createState() => _BioMechanicsState();
}

class _BioMechanicsState extends State<BioMechanics> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(
      'assets/videos/video6.mp4', // Replace with your video path
    )..initialize().then((_) {
      setState(() {});
    });
  }
